...
@Stable
public abstract class AbstractText : CharSequence {
  @PublishedApi
  ...
  public inline fun <T> source(action: BufferedSource.() -> T): T = action(buffer)
  public inline fun <T> sink(action: BufferedSink.() -> T): T = action(buffer)
  ...
  protected fun ByteString.asCharSequence(): CharSequence = object : CharSequence {
